...
const asia = new Set<Country>(['Узбекистан', "Иран", 'Южная Корея', "Япония", "Казахстан"])
const europe = new Set<Country>(['Россия', "Турция", "Армения", "Белоруссия", "Сербия", 'Швейцария',
    "Босния и Герцеговина", "Норвегия", "Хорватия", "Чехия", "Польша", "Швеция", "Финляндия",
    "Болгария", "Латвия", "Словения", "Литва", "Исландия", "Израиль"])
